...
if (!Yii::app()->user->isGuest) {
    ...
    <div class="row">
        <div class="col-md-6">
            <?php echo CHtml::image(Yii::app()->request->baseUrl . "/shareimages/company/logo.jpg", Yii::app()->name, ["width" => "100%", 'id' => 'photo', 'style' => 'padding:0']); ?>
        </div>
        ...
        <div class="col-md-6">
            <div class="pull-right">
                ...
                $this->widget('booster.widgets.TbTabs', [
                    ...
                    'tabs' => include(Yii::app()->basePath . '/config/guestMenu.php'),
                ]);
                ?>
            </div>
        </div>
