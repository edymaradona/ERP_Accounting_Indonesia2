...
class Process
{
     ...
     * @api
     */
    public function __construct($commandline, $cwd = null, array $env = null, $stdin = null, $timeout = 60, array $options = [])
    {
        ...
        $this->options = array_merge(['suppress_errors' => true, 'binary_pipes' => true, 'bypass_shell' => false], $options);
    }
