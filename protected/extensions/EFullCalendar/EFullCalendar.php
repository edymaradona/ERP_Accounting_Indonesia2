...
class EFullCalendar extends CWidget
{
    ...
    protected function registerFiles()
    {
        ...
        $cs->registerScriptFile($this->enableCdn ? "//cdnjs.cloudflare.com/ajax/libs/fullcalendar/1.6.4/fullcalendar." . $ext
            : $assets . '/fullcalendar/fullcalendar.' . $ext);
        //$cs->registerScriptFile($assets.'/fullcalendar/jquery-ui-1.8.23.custom.min.js');
        $cs->registerCssFile($this->enableCdn ? "//cdnjs.cloudflare.com/ajax/libs/fullcalendar/1.6.4/fullcalendar.css"
