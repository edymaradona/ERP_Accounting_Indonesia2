...
//        $this->checkParams();
        ...
        if (!is_string($value)) {
            $this->addError($object,
                ...
                [':attribute' => $attribute, ':type' => gettype($value)]
            );
    ...
    private function addErrorInternal($object, $attribute, $tested_param, array $values)
    {
        ...
        $params = [':attribute' => $attribute, ':tested_param' => $tested_param, ':found' => $values['found'], ':required' => $values['required']];
