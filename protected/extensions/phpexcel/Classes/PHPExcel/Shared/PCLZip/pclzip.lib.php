    ...
    function create($p_filelist)
    {
        ...
        if ($v_size > 1) {
            ...
            if ((is_integer($v_arg_list[0])) && ($v_arg_list[0] > 77000)) {
                ...
                // ----- Parse the options
                $v_result = $this->privParseOptions($v_arg_list, $v_size, $v_options, [PCLZIP_OPT_REMOVE_PATH => 'optional',
...
//    $v_path = "./";
    ...
    function delete()
    {
        ...
        if ($v_size > 0) {
            ...
            // ----- Parse the options
            $v_result = $this->privParseOptions($v_arg_list, $v_size, $v_options, [PCLZIP_OPT_BY_NAME => 'optional',
                PCLZIP_OPT_BY_EREG => 'optional',
                PCLZIP_OPT_BY_PREG => 'optional',
                PCLZIP_OPT_BY_INDEX => 'optional']);
            if ($v_result != 1) {
