...
(function (g) {
    ...
    p(r.prototype, {defaultColorAxisOptions: {lineWidth: 0, gridLineWidth: 1, tickPixelInterval: 72, startOnTick: !0, endOnTick: !0, offset: 0, marker: {animation: {duration: 50}, color: "gray", width: 0.01},
        labels: {overflow: "justify"}, minColor: "#EFEFFF", maxColor: "#003875", tickLength: 5}, init: function (b, a) {
        var d = b.options.legend.layout !== "vertical", c;
        c = l(this.defaultColorAxisOptions, {side: d ? 2 : 1, reversed: !d}, a, {isX: d, opposite: !d, showEmpty: !1, title: null, isColor: !0});
        ...
        k(this.dataClasses, function (c, g) {
            ...
            l !== void 0 && m !== void 0 && (f += " - ");
            m !== void 0 && (f += v(m, e) + h);
            d.push(p({chart: a, name: f, options: {}, drawLegendSymbol: s.drawRectangle, visible: !0, setState: n, setVisible: function () {
                j =
                    this.visible = !j;
    ...
    g = {pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", dashstyle: "dashStyle"}, pointArrayMap: ["value"], axisTypes: ["xAxis", "yAxis", "colorAxis"], optionalAxis: "colorAxis", trackerGroups: ["group", "markerGroup", "dataLabelsGroup"], getSymbol: n, parallelArrays: ["x", "y", "value"], translateColors: function () {
    ...
    m.heatmap = z(m.scatter, l(g, {type: "heatmap", pointArrayMap: ["y", "value"], hasPointSpecificOptions: !0, supportsDrilldown: !0, getExtremesFromAll: !0, init: function () {
        ...
        k(this.points, function (c) {
            ...
            c.plotY = (g + h) / 2;
            c.shapeType = "rect";
            c.shapeArgs = {x: Math.min(f,
                e), y: Math.min(g, h), width: Math.abs(e - f), height: Math.abs(h - g)}
        });
        this.translateColors()
    }, drawPoints: m.column.prototype.drawPoints, animate: n, getBox: n, drawLegendSymbol: s.drawRectangle, getExtremes: function () {
