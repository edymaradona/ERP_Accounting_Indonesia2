...
class EQuickDlgs
{
     ...
     * @return bool
     */
    public static function renderPartial($view, $data = [], $return = false, $processOutput = false, $iframeLayout = null, &$controller = null)
    {
     ...
     * @return bool
     */
    public static function render($view, $data = [], $return = false, $iframeLayout = null, $controller = null)
    {
