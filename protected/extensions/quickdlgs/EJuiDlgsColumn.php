...
Yii::import('ext.booster.widgets.TbButtonColumn');
...
class EJuiDlgsColumn extends TbButtonColumn
{
    ...
    protected function initUpdateButton()
    {
        if (!isset($this->updateDialog['controllerRoute'])) {
            ...
            $this->updateDialog['actionParams'] = ['id' => '$data->primaryKey'];
        }
        ...
        $updateButton = !empty($this->buttons['update']) ? $this->buttons['update'] : [];
    ...
    protected function initViewButton()
    {
        if (!isset($this->viewDialog['controllerRoute'])) {
            ...
            $this->viewDialog['actionParams'] = ['id' => '$data->primaryKey'];
        }

        if (!isset($this->viewDialog['closeOnAction']))
            $this->viewDialog['closeOnAction'] = true;

        $viewButton = !empty($this->buttons['view']) ? $this->buttons['view'] : [];
    ...
    protected function renderViewDialogWidget()
    {
        ...
        $widgetAttributes['actionParams'] = []; //reset for the widget: was used to create the button url;
    ...
    {
        $paramStr = '';
        $actionParams = isset($this->viewDialog['actionParams']) ? $this->viewDialog['actionParams'] : [];
    ...
    protected function getUpdateButtonUrl()
    {
        ...
        $actionParams = isset($this->updateDialog['actionParams']) ? $this->updateDialog['actionParams'] : [];
