...
class EFrameJuiDlg extends EBaseJuiDlg
{
    ...
    public function renderDialogContent()
    {
        ...
        $htmlOptions = array_merge($this->iframeHtmlOptions, ['style' => 'position: absolute; width:95%; height: 95%;padding:10px', 'src' => $src, 'id' => $this->getFrameId()]);
