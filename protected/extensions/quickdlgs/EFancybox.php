...
class EFancybox extends CWidget
{
     ...
     */
    public function image($smallImgSrc, $largeImgSrc, $smallImgAlt = '', $smallImgHtmlOptions = [], $linkHtmlOptions = [], $iframe = false)
    {
        $this->_hasImage = true;
     ...
     */
    public function content($linkText, $content, $linkHtmlOptions = [], $contentHtmlOptions = [])
    {
     ...
     * @param array $linkHtmlOptions
     */
    public function url($linkText, $url, $linkHtmlOptions = [], $iframe = false)
    {
        $this->_hasUrl = true;
