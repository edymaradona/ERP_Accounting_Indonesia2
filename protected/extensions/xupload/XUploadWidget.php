...
class XUploadWidget extends CJuiInputWidget
{
    ...
    public function run()
    {
        ...
        echo CHtml::tag("button", [], "Upload", true);
        echo CHtml::tag("div", [], "Upload file", true);

        echo CHtml::endForm();

        if ($uploadTable == $downloadTable) {
            echo CHtml::tag("table", ["id" => $uploadTable], "", true);
        } else {
            echo CHtml::tag("table", ["id" => $uploadTable], "", true);
            echo CHtml::tag("table", ["id" => $downloadTable], "", true);
        }
