...
class Booster extends CApplicationComponent
{
    ...
    public $bootswatchTheme = 'cerulean';
    ...
    protected function createBootstrapCssPackage()
    {
        ...
        return ['bootstrap.css' => [
            'baseUrl' => $this->enableCdn ? '//maxcdn.bootstrapcdn.com/bootswatch/3.2.0/' . $this->bootswatchTheme . '/' : $this->getAssetsUrl() . '/bootstrap/css/',
            'css' => [($this->minify || $this->enableCdn) ? 'bootstrap.min.css' : 'bootstrap.css'],
        ]];
    }
