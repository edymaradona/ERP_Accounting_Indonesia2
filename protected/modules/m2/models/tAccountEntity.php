...
class tAccountEntity extends BaseModel
{
    ...
    {
        return [
            ['parent_id, entity_id, state_id', 'required'],
            ['parent_id, entity_id, state_id, created_date, created_by', 'numerical', 'integerOnly' => true],
            //array('parent_id', 'unique'),
            ['parent_id', 'UniqueAttributesValidator', 'with' => 'entity_id', 'message' => 'This Entity already inputed...'],
            ['remark', 'safe'],
            ['id, parent_id, entity_id, remark, state_id, created_date, created_by', 'safe', 'on' => 'search'],
        ];
    }
