...
class fJournal extends CFormModel
{
    ...
    {
        return [
            ['input_date, account_no_id, debit, credit,remark', 'required'],
            ['cb_receiver', 'required', 'on' => 'expense'],
            ['cb_received_from', 'required', 'on' => 'income'],
            ['field', 'multiItemRequired', 'compare' => 'cb_receiver,cb_received_from', 'on' => 'cashbank'],
            ['input_date', 'type', 'type' => 'date', 'dateFormat' => 'dd-MM-yyyy'],
            ['balance', 'boolean', 'allowEmpty' => false, 'strict' => true, 'trueValue' => "OK", 'message' => 'Journal is not Balance'],
            ['cb_receiver,cb_received_from', 'safe'],
        ];
    }
