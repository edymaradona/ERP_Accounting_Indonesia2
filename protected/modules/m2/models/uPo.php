...
class uPo extends BaseModel
{
    ...
    public function rules()
    {
        ...
        return [
            ['input_date', 'required'],
            ['state_id, entity_id, supplier_id, po_type_id, created_date, created_by, updated_date, updated_by, approved_date, approved_by', 'numerical', 'integerOnly' => true],
            ['system_ref', 'length', 'max' => 100],
            ['remark', 'safe'],
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            ['id, entity_id, supplier_id, input_date, system_ref, po_type_id, remark, created_date, created_by, updated_date, updated_by, approved_date, approved_by', 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function relations()
    {
        ...
        return [
            ...
            'supplier' => [self::BELONGS_TO, 'uSupplier', 'supplier_id'],
            'ap' => [self::HAS_ONE, 'uAp', 'id'],
            'poDetail' => [self::HAS_MANY, 'uPoDetail', 'parent_id'],
            'poSum' => [self::STAT, 'uPoDetail', 'parent_id', 'select' => 'sum(qty*amount)'],
        ];
    }
    ...
    public static function getTopCreated()
    {
        ...
        foreach ($models as $model) {
            $returnarray[] = ['id' => $model->system_ref, 'label' => $model->system_ref, 'icon' => 'list-alt', 'url' => ['/m2/uPo/view', 'id' => $model->id]];
        }
