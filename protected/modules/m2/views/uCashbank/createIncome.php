...
$this->widget('booster.widgets.TbMenu', [
    ...
    'items' => [
        ['label' => 'Expense', 'url' => Yii::app()->createUrl('/m2/uCashbank/create')],
        ['label' => 'Income', 'url' => Yii::app()->createUrl('/m2/uCashbank/createIncome'), 'active' => true],
    ],
]);

echo $this->renderPartial('_tabCreateIncome', ['model' => $model]);
