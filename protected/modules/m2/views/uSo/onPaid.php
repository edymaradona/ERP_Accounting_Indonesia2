...
$this->widget('booster.widgets.TbMenu', [
    ...
    'items' => [
        ...
        ['label' => 'Full Paid', 'url' => Yii::app()->createUrl('/m2/uSo/onPaid'), 'active' => true],
    ],
]);
?>
...
$this->widget('booster.widgets.TbGridView', [
    ...
    'columns' => [
        ...
        [
            'name' => 'so.system_ref',
            'type' => 'raw',
            'value' => 'CHtml::link($data->so->system_ref,Yii::app()->createUrl("/m2/uSo/view",array("id"=>$data->id)))'
        ],
        'so.input_date',
        //'entity.name',
        [
