...
class MessageController extends Controller
{
    ...
    public $buttons = [ // Ex output: {count} messages have been {value}
        'default' => ['delete' => 'deleted', 'read' => 'marked read', 'unread' => 'marked unread'],
        'trash' => ['delete' => 'permanently deleted', 'restore' => 'restored']
    ];
    ...
    public function actionInbox($ajax = null)
    {
        ...
        if (isset($ajax))
            $this->renderPartial('_mailbox', ['dataProvider' => $dataProvider]);
        else {
            if (!isset($_GET['Mailbox_sort']))
                $_GET['Mailbox_sort'] = 'modified.desc';

            $this->render('mailbox', ['dataProvider' => $dataProvider]);
        }
    }
    ...
    public function actionNew()
    {
        ...
        if (isset($_POST['Mailbox']['to'])) {
            ...
            $validate = $conv->validate(['text'], false); // html purify
            $msg->created = $t;
        ...
        $this->render('compose', ['conv' => $conv, 'msg' => $msg]);
    }
    ...
    public function actionReply()
    {
        ...
        if (isset($_POST['text'])) {
            ...
            if ($validate) {
                ...
                $this->render('message', ['conv' => $conv, 'reply' => $reply]);
            }
        }
    }
