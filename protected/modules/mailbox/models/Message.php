...
class Message extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ['text', 'required'],
            ['created, sender_id, recipient_id', 'length', 'max' => 10],
            ['text', 'filter', 'filter' => [$p, 'purify']],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['message_id, conversation_id, created, sender_id, recipient_id, text, hash', 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function relations()
    {
        ...
        return [
            'conversation' => [self::HAS_ONE, 'Mailbox', 'conversation_id'],
        ];
    }
