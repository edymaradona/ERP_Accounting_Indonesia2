 ...
 */
class GroupGridView extends TbGridView
{
    ...
    public function renderTableRow($row)
    {
        ...
        if ($this->rowCssClassExpression !== null) {
            ...
            echo '<tr class="' . $this->evaluateExpression($this->rowCssClassExpression, ['row' => $row, 'data' => $data]) . '">';
    ...
    private function renderExtraRow($beforeRow, $change, $columnsInExtra)
    {
        ...
        if ($this->extraRowExpression) { //user defined expression, use it!
            $content = $this->evaluateExpression($this->extraRowExpression, ['data' => $data, 'row' => $beforeRow, 'values' => $change['columns']]);
        } else { //generte value
            $values = [];
