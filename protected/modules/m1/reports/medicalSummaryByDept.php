...
class medicalSummaryByDept extends fpdf
{
    ...
    function myheader($rows, $w)
    {
        ...
        $this->Ln();
        $this->Cell(30, 5, '', 'L');
        $this->Cell(0, 5, 'LAPORAN PENGGUNAAN MEDICAL', 'R', 0, 'C');
        $this->Ln();
        $this->Cell(0, 5, '', 'LBR');
        $this->Ln(1);
        ...
        $this->Cell($w[3] + $w[4] + $w[5], 4, '', 1, 0, 'C');
        $this->Cell($w[6], 4, '', 'LTR', 0, 'C');
        $this->Cell($w[7], 4, '', 'LTR', 0, 'C');
