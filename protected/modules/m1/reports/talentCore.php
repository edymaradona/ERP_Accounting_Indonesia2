...
class talentCore extends fpdf
{
    ...
    function myheader($models, $w)
    {
        ...
        $this->Cell(0, 5, 'ASPEK 2. KOMPETENSI INTI');
        $this->Ln();
    ...
    function report($models)
    {
        ...
        foreach ($models as $model) {
            ...
            $this->Cell($w[1], 5, $model->talent_template->aspect, 'LT', 0, 'L');
            $y1 = $this->GetY();
            $this->MultiCell($w[2], 5, $model->talent_template->description, 'LT');
            $y2 = $this->GetY();
            $yH = $y2 - $y1;
