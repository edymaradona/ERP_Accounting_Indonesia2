...
<?php echo $form->textFieldGroup($model, 'start_date', ['hint' => 'For Extended Leave type, your extended leave will valid up to: '
    . date("d-m-Y", strtotime("-1 day", strtotime($model->start_date . " +6 months"))), 'widgetOptions' => [
