...
<div class="row">
  <div class="col-md-12">  
    ...
    <div id="animatedImage" style="position: relative;">
     <img src = <?php echo Yii::app()->baseUrl . "/css/santa.gif" ?> alt="animatedImage" />
    </div>

    <?php 
      Yii::app()->clientScript->registerScript('santa', '
    ...
    //400
    if (santa_move> (window.screen.width / 2)) { 
      //santa_direction=-1; 
    document.getElementById(\'animatedImage\').style.top = 10;
    document.getElementById(\'animatedImage\').style.left = 10;
    santa_move=0;
...
<?php echo $this->renderPartial("_tabRequest", [], true); ?>

<?php echo $this->renderPartial("_tabAnnouncement", [], true); ?>

<?php echo $this->renderPartial("_tabAttendance", ['model' => $model], true); ?>

<div class="row">
  <div class="col-md-6">  
    <?php echo $this->renderPartial("_today", ['model' => $model], true); ?>
  </div>
  <div class="col-md-6">  
    <?php echo $this->renderPartial("_library", ['model' => $model], true); ?>
  </div>
</div>

<?php echo $this->renderPartial("_tabMailbox", [], true); ?>

<?php //echo $this->renderPartial("_tabQuote", [], true); ?>

<?php echo $this->renderPartial("_tabForum", ['threadsProvider' => $threadsProvider,], true); ?>

<br/>
<?php echo $this->renderPartial("_tabLearning", [], true); ?>
