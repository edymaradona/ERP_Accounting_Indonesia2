            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    if ($this->id == "gPerson") {
                        ...
                        echo CHtml::tag('div', ['style' => 'font-weight: bold'], $data->GTalentLink);
                    ?>
                    <?php echo CHtml::tag('div', ['style' => 'font-size: 11px'], $data->mJobTitle()) ?>
                    <?php echo CHtml::tag('div', ['style' => 'color: #999; font-size: 11px'], $data->mLevel()); ?>
                    <?php
                    $un = (isset($data->user)) ? $data->user->username : "";
