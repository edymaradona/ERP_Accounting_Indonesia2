...
<div class="row">
    <div class="col-md-3">
        ...
        <p>
            <?php
            $un = (isset($model->user->username)) ? $model->user->username : "";
            echo CHtml::link('Send Message', Yii::app()->createUrl('mailbox/message/new', ['to' => $un]), ['class' => 'btn btn-default btn-xs btn-block'])
            ?>
        </p>
