...
$this->widget('booster.widgets.TbTabs', [
    ...
    'tabs' => [
        ...
        ['label' => 'Approved By Superior ' . $onsupplier, 'url' => Yii::app()->createUrl('/m1/gLeave/onSuperior')],
        ['label' => 'Approved Leave ' . $onapproved, 'url' => Yii::app()->createUrl('/m1/gLeave/onApproved')],
        ['label' => 'Employee On Leave ' . $onleave, 'url' => Yii::app()->createUrl('/m1/gLeave/onLeave'), 'active' => true],
