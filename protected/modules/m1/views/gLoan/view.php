...
$this->menu = [
    //array('label'=>'Print Summary', 'icon'=>'print', 'url'=>array('/m1/gEss/summaryLoan',"pid"=>$model->id)),
];
...
$this->widget('booster.widgets.TbTabs', [
    ...
    'tabs' => [
        ['label' => 'Loan History', 'content' => $this->renderPartial("_tabList", ["model" => $model], true), 'active' => true],
