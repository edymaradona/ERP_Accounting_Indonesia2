...
$(function() {
		...
		//$( \"#" . CHtml::activeId($model, 'process_date') . "\" ).mask('99-99-9999 99:99');
		$( \"#" . CHtml::activeId($model, 'paid_date') . "\" ).mask('99-99-9999 99:99');
		$( \"#" . CHtml::activeId($model, 'loan_type_id') . "\" ).mask('9?9');
...
<div class="form-group">
    <?php echo $form->labelEx($model, 'process_date', ['class' => 'col-sm-3 control-label']); ?>
    <div class="col-sm-9">
        <?php
        $this->widget(
...
<div class="form-group">
    <?php echo $form->labelEx($model, 'paid_date', ['class' => 'col-sm-3 control-label']); ?>
    <div class="col-sm-9">
        <?php
        $this->widget(
            'ext.EJuiDateTimePicker.EJuiDateTimePicker', [
...
<?php echo $form->textFieldGroup($model, 'loan_type_id'); ?>
