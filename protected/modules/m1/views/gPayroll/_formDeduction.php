...
Yii::app()->clientScript->registerScript('monthpicker3', "
        $(function() {
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php echo $form->dropDownListGroup($model, 'deduction_id', ['widgetOptions' => [
            'data' => gParamPayroll::deductionDropDown()
        ]]); ?>
        ...
        <?php echo $form->numberFieldGroup($model, 'prorate', ['widgetOptions' => ['htmlOptions' => ['min' => 0]]]); ?>
