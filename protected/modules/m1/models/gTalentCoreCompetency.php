...
class gTalentCoreCompetency extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ['talent_template_id,company_id, year, period_id, superior_score, personal_score,
