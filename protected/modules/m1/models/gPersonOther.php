...
class gPersonOther extends BaseModel
{
    ...
    public function rules()
    {
        ...
        return [
            ['parent_id, category_name', 'required'],
            ['parent_id', 'numerical', 'integerOnly' => true],
            ['category_name, document_number, custom_info1, custom_info2, custom_info3', 'length', 'max' => 50],
            ['remark', 'length', 'max' => 300],
            ['issued_date, valid_to', 'safe'],
            ['issued_date', 'date', 'format' => 'dd-MM-yyyy'],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['id, parent_id, category_name, document_number, issued_date, valid_to, custom_info1, custom_info2, custom_info3, remark', 'safe', 'on' => 'search'],
        ];
    }
