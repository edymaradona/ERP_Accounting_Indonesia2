...
class Rights
{
    ...
    public static function getAuthItemRoute($type)
    {
        switch ((int)$type) {
            case CAuthItem::TYPE_OPERATION:
                return ['authItem/operations'];
            case CAuthItem::TYPE_TASK:
                return ['authItem/tasks'];
            case CAuthItem::TYPE_ROLE:
    ...
    public static function getValidChildTypes($type)
    {
        switch ((int)$type) {
            ...
            case CAuthItem::TYPE_TASK:
                return [CAuthItem::TYPE_TASK, CAuthItem::TYPE_OPERATION];
     ...
     */
    public static function getAuthItemSelectOptions($type = null, $exclude = [])
    {
        $authorizer = self::getAuthorizer();
     ...
     * @return array the select options.
     */
    public static function getParentAuthItemSelectOptions(CAuthItem $parent, $type = null, $exclude = [])
    {
        $authorizer = self::getAuthorizer();
