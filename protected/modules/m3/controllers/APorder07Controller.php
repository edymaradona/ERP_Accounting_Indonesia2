...
class aPorder07Controller extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['aPorder'])) {
            ...
            if ($model->validate()) {
                ...
                $modelHeader->organization_id = sUser::model()->myGroup; //default user Group
    ...
    public function actionUpdate($id)
    {
        ...
        if (isset($_POST['aPorder'])) {
            ...
            if ($model->validate()) {
                ...
                $t = aPorderDetail::model()->deleteAll([
        ...
        $modelDetail = aPorderDetail::model()->findAll([
            'condition' => 'parent_id = :parent',
            'params' => [':parent' => $model->id],
            'order' => 'id'
        ]);
    ...
    public function actionDeleteDetail($id)
    {
        ...
        $this->redirect(['/m3/aPorder/view', 'id' => $model->parent_id]);
    }
