...
class aBudgetController extends Controller
{
    ...
    public function actionAjaxFillTreeCP()
    {
        ...
        foreach ($children as $child) {
            $options = ['href' => Yii::app()->createUrl('aBudget/index', ['id' => $child['id']]), 'id' => $child['id'], 'class' => 'treenode'];
    ...
    public function actionAjaxFillTreeRMG()
    {
        ...
        $treedata = [];
        foreach ($children as $child) {
            $options = ['href' => Yii::app()->createUrl('aBudget/index', ['id' => $child['id'], 'pro_id' => 2]), 'id' => $child['id'], 'class' => 'treenode'];
            $nodeText = CHtml::openTag('a', $options);
            $nodeText .= $child['text'];
            $nodeText .= CHtml::closeTag('a') . "\n";
            $child['text'] = $nodeText;
