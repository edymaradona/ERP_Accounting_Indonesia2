...
class aBudgetDepartment extends BaseModel
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            ['parent_id, periode_date, department_id, created_date, updated_date', 'numerical', 'integerOnly' => true],
            ['no_ref, remark', 'length', 'max' => 100],
            ['tdebt, tcredit, balance, created_by, updated_by', 'length', 'max' => 15],
            ['input_date', 'safe'],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['id, parent_id, input_date, periode_date, no_ref, department_id, tdebt, tcredit, balance, remark, created_date, created_by, updated_date, updated_by', 'safe', 'on' => 'search'],
        ];
    }
