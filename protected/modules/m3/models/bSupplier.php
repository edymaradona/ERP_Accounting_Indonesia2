...
class bSupplier extends BaseModel
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            ['gid, province_id, created_date, updated_date', 'numerical', 'integerOnly' => true],
            ['parent_id', 'length', 'max' => 11],
            ['person_incharge', 'length', 'max' => 40],
            ['company_name, phone, fax, handphone', 'length', 'max' => 50],
            ['address1', 'length', 'max' => 100],
            ['address2', 'length', 'max' => 20],
            ['address3, address4', 'length', 'max' => 30],
            ['pos_code', 'length', 'max' => 7],
            ['created_by, updated_by', 'length', 'max' => 15],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['id, gid, parent_id, person_incharge, company_name, address1, address2, address3, address4, pos_code, province_id, phone, fax, handphone, created_date, created_by, updated_date, updated_by', 'safe', 'on' => 'search'],
        ];
    }
