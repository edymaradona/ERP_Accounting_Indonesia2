...
$this->widget('booster.widgets.TbMenu', [
    ...
    'items' => [
        ['label' => 'Waiting for Approval', 'url' => Yii::app()->createUrl('/m3/aPorder07', ["id" => 1]), 'active' => ($id == 1)],
        ['label' => 'Waiting for Payment', 'url' => Yii::app()->createUrl('/m3/aPorder07', ["id" => 2]), 'active' => ($id == 2)],
        ['label' => 'Paid', 'url' => Yii::app()->createUrl('/m3/aPorder07', ["id" => 3]), 'active' => ($id == 3)],
        ['label' => 'Show All', 'url' => Yii::app()->createUrl('/m3/aPorder07', ["id" => 0]), 'active' => ($id == 0)],
    ],
]);
?>
