...
class dAddressbook extends BaseModel
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            ['company_name, title', 'length', 'max' => 100],
            ['address1, address2, address3, handphone, email', 'length', 'max' => 255],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['id, complete_name, company_name, title, address1, address2, address3, handphone, email', 'safe', 'on' => 'search'],
        ];
    }
