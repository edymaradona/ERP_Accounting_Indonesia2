...
class eaAsset extends BaseModel
{
    ...
    public function rules()
    {
        ...
        return [
            ['accesslevel_id, input_date, periode_date, category_id, supplier_id', 'required'],
            ['accesslevel_id, periode_date, category_id, supplier_id, created_date, updated_date', 'numerical', 'integerOnly' => true],
            ['price', 'numerical'],
            ['item, brand, type, warranty, insurance, created_by, updated_by', 'length', 'max' => 50],
            ['serial_number', 'length', 'max' => 100],
            ['inventory_code, bpb_number, po_number, other1, other2, other3, other4, remark', 'length', 'max' => 255],
            ['photo_path', 'length', 'max' => 150],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['id, accesslevel_id, input_date, periode_date, category_id, item, brand, type, serial_number, inventory_code, bpb_number, supplier_id, po_number, price, other1, other2, other3, other4, warranty, insurance, remark, photo_path, created_date, created_by, updated_date, updated_by', 'safe', 'on' => 'search'],
        ];
    }
