...
class ebAssetCondition extends BaseModel
{
    ...
    public function rules()
    {
        ...
        return [
            ['parent_id, input_date, state_id', 'required'],
            ['parent_id, state_id', 'numerical', 'integerOnly' => true],
            ['description', 'length', 'max' => 255],
            ['checked_by', 'length', 'max' => 50],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['id, parent_id, input_date, state_id, description, checked_by', 'safe', 'on' => 'search'],
        ];
    }
