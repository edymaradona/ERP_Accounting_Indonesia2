...
class ebAssetOwner extends BaseModel
{
    ...
    public function rules()
    {
        ...
        return [
            ['parent_id, input_date, owner_id, location_id', 'required'],
            ['parent_id, owner_id, location_id', 'numerical', 'integerOnly' => true],
            ['remark', 'length', 'max' => 255],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['id, parent_id, input_date, owner_id, location_id, remark', 'safe', 'on' => 'search'],
        ];
    }
