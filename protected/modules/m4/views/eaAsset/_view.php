<div class="view">
    <div class="view-c1">
        ...
        if ($data->photo_path == null) {
            echo CHtml::image(Yii::app()->request->baseUrlCdn . "/images/asset.jpg", "No Photo", ["height" => "90"]);
        } else {
            echo CHtml::image(Yii::app()->request->baseUrlCdn . "/images/asset/" . $data->photo, CHtml::encode($data->name), ["height" => "90"]);
        }
        ?>
    </div>
    <div class="view-c2">
        <?php echo CHtml::link(CHtml::encode($data->item), ['view', 'id' => $data->id]); ?>
