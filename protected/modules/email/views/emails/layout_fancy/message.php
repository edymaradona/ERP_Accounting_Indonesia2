        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td align="center" valign="top">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="600" align="center"
                           style="border-radius:6px!important;background-color:#fdfdfd;border:1px solid #d6d6d6;border-radius:6px!important">
                        <tbody>
                        <?php if ($heading) { ?>
                            <tr>
                                <td align="center" valign="top">
                                    <table border="0" cellpadding="0" cellspacing="0" width="600"
                                           style="background-color:#394755;color:#ffffff;border-top-left-radius:6px!important;border-top-right-radius:6px!important;border-bottom:0;font-family:Arial;font-weight:bold;line-height:100%;vertical-align:middle"
                                           bgcolor="#557da1">
                                        <tbody>
                                        <tr>
                                            <td>
                                        ...
                                        <td valign="top" style="background-color:#fdfdfd;border-radius:6px!important">
                                            <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <div
                                                            style="color:#4d4d4d;font-family:Arial;font-size:14px;line-height:150%;text-align:left">
                                                            <?php echo $contents; ?>
                                                        </div>
                                                    </td>
                                                </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="600" align="center">
                        <tr>
                            <td>
                                <div
                                    style="color:#737373;font-family:Arial;font-size:12px;line-height:150%;text-align:left">
                                    <br/>
