...
class EmailModule extends CWebModule
{
     ...
     */
    public $controllerFilters = [
        'emailAccess' => ['email.components.EmailAccessFilter'],
    ];
    ...
    {
        return Yii::t('email', 'Powered by {yii-email-module}.', ['{yii-email-module}' => '<a href="https://github.com/cornernote/yii-email-module#yii-email-module" rel="external">Yii Email Module</a>']);
    }
    ...
    public function getDbConnection()
    {
        ...
        elseif (($id = $this->connectionID) !== null) {
            if (($this->_db = Yii::app()->getComponent($id)) instanceof CDbConnection)
                ...
                throw new CException(Yii::t('email', 'EmailModule.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.', ['{id}' => $id]));
        } else {
