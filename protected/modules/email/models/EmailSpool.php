 ...
 *
 * @see CActiveRecord
 * @method EmailSpool find() find($condition, array $params = [])
 * @method EmailSpool findByPk() findByPk($pk, $condition = '', array $params = [])
 * @method EmailSpool findByAttributes() findByAttributes(array $attributes, $condition = '', array $params = [])
 * @method EmailSpool findBySql() findBySql($sql, array $params = [])
 * @method EmailSpool[] findAll() findAll($condition = '', array $params = [])
 * @method EmailSpool[] findAllByPk() findAllByPk($pk, $condition = '', array $params = [])
 * @method EmailSpool[] findAllByAttributes() findAllByAttributes(array $attributes, $condition = '', array $params = [])
 * @method EmailSpool[] findAllBySql() findAllBySql($sql, array $params = [])
...
class EmailSpool extends EmailActiveRecord
{
    ...
    public function rules()
    {
        ...
        if ($this->scenario == 'search') {
            $rules[] = ['id, transport, template, priority, status, model_name, model_id, to_address, from_address, subject, message, sent, created', 'safe'];
        }
        return $rules;
    }
