 ...
 *
 * @see CActiveRecord
 * @method EmailToken find() find($condition, array $params = [])
 * @method EmailToken findByPk() findByPk($pk, $condition = '', array $params = [])
 * @method EmailToken findByAttributes() findByAttributes(array $attributes, $condition = '', array $params = [])
 * @method EmailToken findBySql() findBySql($sql, array $params = [])
 * @method EmailToken[] findAll() findAll($condition = '', array $params = [])
 * @method EmailToken[] findAllByPk() findAllByPk($pk, $condition = '', array $params = [])
 * @method EmailToken[] findAllByAttributes() findAllByAttributes(array $attributes, $condition = '', array $params = [])
 * @method EmailToken[] findAllBySql() findAllBySql($sql, array $params = [])
...
class EmailToken extends EmailActiveRecord
{
    ...
    public function rules()
    {
        ...
        if ($this->scenario == 'search') {
            $rules[] = ['id, token, model_name, model_id, uses_allowed, uses_remaining, expires, created', 'safe'];
        }
        return $rules;
    }
    ...
    public function checkToken($model_name, $model_id, $plain)
    {
        ...
        $token = self::model()->find("model_name=:model_name AND model_id=:model_id ORDER BY t.created DESC, t.id DESC", [
