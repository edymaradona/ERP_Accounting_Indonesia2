...
class EmailTemplateController extends EmailWebController
{
    ...
    public function beforeRender($view)
    {
        if (!parent::beforeRender($view))
            return false;
        if ($view != 'index')
            $this->addBreadcrumb(Yii::t('email', 'Templates'), Yii::app()->user->getState('index.emailTemplate', ['template/index']));
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['EmailTemplate'])) {
            ...
            if ($emailTemplate->save()) {
                $this->redirect(['template/view', 'id' => $emailTemplate->id]);
            }
        }
    ...
    public function actionDelete($id)
    {
        ...
        $this->redirect(Yii::app()->user->getState('index.emailTemplate', ['template/index']));
    }
