...
class EmailMustache
{
    ...
    protected function _renderPragmas($template)
    {
        ...
        return preg_replace_callback($regEx, [$this, '_renderPragma'], $template);
    }
    ...
    protected function _getPragmaOptions($pragma_name)
    {
        ...
        return (is_array($this->_localPragmas[$pragma_name])) ? $this->_localPragmas[$pragma_name] : [];
    }
