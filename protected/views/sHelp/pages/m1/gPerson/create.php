...
<p>
    Halaman ini menampilkan form untuk menyyimpan data pegawai baru. Untuk menyimpan data pegawai baru, isikan data
    pegawai di form tersebut, lalu klik tombol Create. Form data pegawai terdiri dari beberapa bagian yaitu
<ul>
