<?php if (gPermission::model()->onSuperior()->totalItemCount != 0) { ?>

<div style="border: 1px #D5D5D5;border-bottom-style: solid;padding:3px 0;margin:10px 0;">
    <ul class="nav nav-list">
        <li class="nav-header"><i class="fa fa-bars fa-fw"></i><?php echo Yii::t('basic', ' Superior Approved Permission. Note: permission that has been approved by superior MUST be processed (approved/rejected) by HR Dept immediately') ?></li>
    </ul>
</div>
